...
export class Backend implements backendInterface {
    ...
    async addJournalEntry(arg0: JournalEntry): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addJournalEntry(to_candid_JournalEntry_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllUserData(): Promise<AllUserData | null> {
        if (this.processError) {
            try {
    ...
    async getMoodLogByDay(arg0: Time): Promise<Array<DailyMood>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMoodLogByDay(arg0);
    ...
    async getSortedJournalEntries(): Promise<Array<JournalEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSortedJournalEntries();
    ...
    async getTaskList(): Promise<Array<Note>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTaskList();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async logDailyMood(arg0: DailyMood): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.logDailyMood(to_candid_DailyMood_n31(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveUserProfile(arg0: UserProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveUserProfile(to_candid_UserProfile_n33(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_AllUserData_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _AllUserData): AllUserData {
    return from_candid_record_n16(_uploadFile, _downloadFile, value);
}
function from_candid_DailyMood_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _DailyMood): DailyMood {
    return from_candid_record_n19(_uploadFile, _downloadFile, value);
}
function from_candid_JournalEntry_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _JournalEntry): JournalEntry {
    return from_candid_record_n24(_uploadFile, _downloadFile, value);
}
function from_candid_Mood_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _Mood): Mood {
...
function from_candid_opt_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_AllUserData]): AllUserData | null {
    return value.length === 0 ? null : from_candid_AllUserData_n15(_uploadFile, _downloadFile, value[0]);
}
...
function from_candid_record_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    tasks: Array<_Note>;
    moodLog: Array<_DailyMood>;
    journal: Array<_JournalEntry>;
    ...
    return {
        tasks: value.tasks,
        moodLog: from_candid_vec_n17(_uploadFile, _downloadFile, value.moodLog),
        journal: from_candid_vec_n22(_uploadFile, _downloadFile, value.journal),
...
function from_candid_record_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        mood: from_candid_Mood_n20(_uploadFile, _downloadFile, value.mood),
...
function from_candid_record_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        bio: value.bio,
        avatarOutfitColor: value.avatarOutfitColor,
        name: value.name,
        themePreference: value.themePreference,
        avatarSkinTone: value.avatarSkinTone,
        avatarHairStyle: value.avatarHairStyle,
        profilePhotoUrl: record_opt_to_undefined(from_candid_opt_n27(_uploadFile, _downloadFile, value.profilePhotoUrl))
    };
}
...
function from_candid_variant_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "sad" in value ? Mood.sad : "anxious" in value ? Mood.anxious : "happy" in value ? Mood.happy : "excited" in value ? Mood.excited : "neutral" in value ? Mood.neutral : value;
}
...
function from_candid_vec_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_DailyMood>): Array<DailyMood> {
    return value.map((x)=>from_candid_DailyMood_n18(_uploadFile, _downloadFile, x));
}
function from_candid_vec_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_JournalEntry>): Array<JournalEntry> {
    return value.map((x)=>from_candid_JournalEntry_n23(_uploadFile, _downloadFile, x));
}
function to_candid_DailyMood_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: DailyMood): _DailyMood {
    return to_candid_record_n32(_uploadFile, _downloadFile, value);
}
function to_candid_JournalEntry_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: JournalEntry): _JournalEntry {
    return to_candid_record_n9(_uploadFile, _downloadFile, value);
}
function to_candid_Mood_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Mood): _Mood {
...
function to_candid_record_n32(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        mood: to_candid_Mood_n10(_uploadFile, _downloadFile, value.mood),
        timestamp: value.timestamp
    };
}
...
function to_candid_variant_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Mood): {
    sad: null;
} | {
    anxious: null;
} | {
